...
@section('title', 'Profile | ' . env('APP_NAME', 'Framework'))
@section('content')
                ...
                <div class="card custom-card">
                    <ul class="nav nav-tabs tab-style-8 scaleX rounded m-3 profile-settings-tab gap-2" id="myTab4"
                        ...
                        <li class="nav-item me-1" role="presentation">
                            <button class="nav-link  px-4 bg-primary-transparent active" id="account" data-bs-toggle="tab"
                                data-bs-target="#account-pane" type="button" role="tab" aria-controls="account-pane"
                                aria-selected="true">Account</button>
                        </li>
                        <li class="nav-item me-1" role="presentation">
                            <button class="nav-link  px-4 bg-primary-transparent" id="notification-tab" data-bs-toggle="tab"
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link  px-4 bg-primary-transparent" id="security-tab" data-bs-toggle="tab"
                                data-bs-target="#security-tab-pane" type="button" role="tab"
                                aria-controls="security-tab-pane" aria-selected="false" tabindex="-1">Security</button>
                        </li>
                    </ul>
                    <div class="p-3 border-bottom border-top border-block-end-dashed tab-content">
                        <div class="tab-pane show active overflow-hidden p-0 border-0" id="account-pane" role="tabpanel"
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-1">
                                ...
                                <div class="btn btn-primary btn-sm"><i class="ri-loop-left-line lh-1 me-2"></i>Restore
                                    Changes</div>
                            </div>
                            <div class="row gy-3">
                                <div class="col-xl-12">
                                    <div class="d-flex align-items-start flex-wrap gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="btn-list mb-1">
                                                ...
                                                <button class="btn btn-sm btn-primary1-light btn-wave"><i
                        ...
                        <div class="tab-pane overflow-hidden p-0 border-0" id="notification-tab-pane" role="tabpanel"
                            ...
                            <div class="row gx-5 gy-3">
                                <div class="col-xl-12">
                                    ...
                                    <p class="fs-12 mb-0 text-muted">Users can tailor their experience to receive alerts
                                        for the types of events that matter to them.</p>
                                </div>
                                <div class="col-xl-12">
                                    <div class="d-flex align-items-top justify-content-between mt-3">
                                        <div class="mail-notification-settings">
                                            ...
                                            <p class="fs-12 mb-0 text-muted">Alerts sent to the user's mobile device or
                                                desktop.</p>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-top justify-content-between mt-3">
                                        <div class="mail-notification-settings">
                                            ...
                                            <p class="fs-12 mb-0 text-muted">Text messages sent to the user's mobile phone.
                                            </p>
                                        </div>
                        ...
                        <div class="tab-pane overflow-hidden p-0 border-0" id="security-tab-pane" role="tabpanel"
                            ...
                            <div class="d-sm-flex d-block align-items-top justify-content-between">
                                <div class="w-50">
                                    ...
                                    <p class="fs-12 mb-0 text-muted">Control how your profile information is verified for
                                        security purposes.</p>
                                </div>
                            ...
                            <div class="d-sm-flex d-block align-items-top justify-content-between mt-3">
                                <div class="w-50">
                                    ...
                                    <p class="fs-12 mb-0 text-muted">This helps protect accounts from unauthorized access,
                                        even if a password is compromised.</p>
                                </div>
