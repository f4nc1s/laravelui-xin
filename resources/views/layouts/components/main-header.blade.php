            ...
            {{-- <li class="header-element cart-dropdown dropdown">
                ...
                <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-0">
                                        <div class="mb-0 fs-14 fw-medium">
                                            ...
                                            <div class="text-truncate">
                                                <p class="mb-0 header-cart-text text-truncate fs-11 text-muted">
                                ...
                                <div class="flex-fill">
                                    <div class="d-flex align-items-center justify-content-between mb-0">
                                        <div class="mb-0 fs-14 fw-medium">
                                            ...
                                            <div class="text-truncate">
                                                <p class="mb-0 header-cart-text text-truncate fs-11 text-muted">Both
                                                    fashion and functionality. </p>
                                                <h6 class="fw-medium mb-0 mt-1"><span
                                                        class="text-success fw-normal me-1 fs-11 d-inline-block">(Qty
                                                        : 2)</span>$15</h6>
                                            </div>
                                ...
                                <div class="flex-fill">
                                    <div class="d-flex align-items-center justify-content-between mb-0">
                                        <div class="mb-0 fs-14 fw-medium">
                                            ...
                                            <div class="text-truncate">
                                                <p class="mb-0 header-cart-text text-truncate fs-11 text-muted">Add
                    ...
                    <div class="p-3 empty-header-item border-top d-flex gap-2 align-items-center">
                        <a href="checkout.php.html" class="btn flex-fill btn-primary btn-wave">Proceed to
                            checkout</a>
                    </div>
                    <div class="p-5 empty-item d-none">
                        <div class="text-center">
                            ...
                            <a href="products.php.html" class="btn btn-primary1 btn-wave btn-sm m-1"
