                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child2">
                                ...
                                <li class="slide">
                                    <a href="job-candidate-search.php.html" class="side-menu__item">Search
                                        Candidate</a>
                                </li>
                                <li class="slide">
                                    <a href="job-candidate-details.php.html" class="side-menu__item">Candidate
                                        Details</a>
                                </li>
                            </ul>
                        </li>
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child2">
                                ...
                                <li class="slide">
                                    <a href="nft-wallet-integration.php.html" class="side-menu__item">Wallet
                                        Integration</a>
                                </li>
                                <li class="slide">
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child2">
                                ...
                                <li class="slide">
                                    <a href="crypto-currency-exchange.php.html" class="side-menu__item">Currency
                                        Exchange</a>
                                </li>
                                <li class="slide">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child2">
                                ...
                                <li class="slide">
                                    <a href="form-datetime-pickers.php.html" class="side-menu__item">Date,Time
                                        Picker</a>
                                </li>
                                <li class="slide">
